<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                {{-- SE ESTIVER LOGADO, MOSTRA O DROPDOWN COM AS DEFINIÇÕES, CASO CONTRÁRIO O BOTÃO DO LOGIN E REGISTER --}}
                ...
                @else
                    <div class="flex items-center gap-4">
                        <a href="{{ route('login') }}">
                            <button class="w-full bg-yellow-500 font-bold text-white py-2 px-4 rounded-lg">
                                {{ __('Login') }}
                            </button>
                        </a>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- A ROTA DASHBOARD SÓ É MOSTRADA CASO O UTILIZADOR ESTEJA LOGADO --}}
